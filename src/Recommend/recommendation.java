...
public class recommendation {
	...
	private static void RealityScore() {
		try {
			...
			int i=0;
			String userId = "5218791";		//存储上一个用户的ID，用来辨别当前记录
			newsbr.mark((int)newsfile.length());	//标记，用来使BufferReader返回文件开头
